...
class RoutePage(QWidget):
    ...
    def __init__(self, record: dict, route_service, parent: QWidget | None = None) -> None:
        ...
        self.guard_value = self._add_row(info_grid, 2, "防跳转")
        self.message_value = self._add_row(info_grid, 3, "最近消息")
        self.error_value = self._add_row(info_grid, 4, "错误")
        ...
        self.button_scroll_area.setFixedHeight(self.COMPACT_BUTTON_MAX_HEIGHT + 10)
        ...
        root.addWidget(self.routes_tree, 1)
    ...
    def refresh_state(self) -> None:
        ...
        self.current_route_value.setText(current_route or "-")
        self.guard_value.setText(self.guard_text(state))
        ...
        self.sync_route_tree(pages, current_route)

        self.sync_tree_columns()
        self.sync_guard_button(state)
        self.refresh_actions()

    def sync_route_tree(self, pages: list[dict], current_route: str) -> None:
