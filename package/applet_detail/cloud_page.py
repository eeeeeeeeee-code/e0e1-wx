...
class CloudFunctionsPage(QWidget):
    ...
    def sync_scan_tree_columns(self) -> None:
        ...
        flexible_width = max(300, int(width) - fixed_width)
        name_width = max(150, min(220, int(flexible_width * 0.36)))
        params_width = max(200, flexible_width - name_width)
        widths = (
            source_width,
            type_width,
            name_width,
