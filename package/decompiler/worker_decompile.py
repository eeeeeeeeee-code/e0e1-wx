...
from package.decompiler.core import decompile_wxapkg_file, find_wxapkg_files, normalize_new_folder_names, path_inside_root, safe_output_folder_path
    ...
    async def execute_decompile(
        ...
        for new_folder in new_folders:
            ...
            for index, info in enumerate(wxapkg_files, start=1):
                ...
                try:
                    result = await asyncio.to_thread(decompile_wxapkg_file, source_dir, folder_output_dir, wxapkg_path, new_folder)
